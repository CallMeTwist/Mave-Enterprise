                                ...
                                <div class="list-group list-group-flush">
                                    @foreach(explode(', ', $inspection->locations) as $code)
                                        ...
                                        <div class="list-group-item p-3 d-flex align-items-center justify-content-between">
                                            ...
                                            <span><a href="{{ route('admin.kit.locations.view', $code) }}"><i class="fa fa-arrow-circle-right"></i></a></span>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="m-t-20">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="px-3 pt-3 text-center">
                                            ...
                                            <form method="post" action="{{ route('admin.kit.inspection.approve') }}">
                                                @csrf
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="text-center">
                                        <form method="post" action="{{ route('admin.kit.inspection.delete') }}">
                                            @csrf
                                            <input type="hidden" name="inspection" value="{{ $inspection->id }}" required>
