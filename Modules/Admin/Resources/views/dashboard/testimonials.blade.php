<x-kit.dashboard>
    ...
    <div class="card rounded-0 shadow-lg">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.dashboard.testimonials.save') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ route('admin.dashboard.testimonials.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="text-center">
                                        <form method="post" action="{{ route('admin.dashboard.testimonials.delete') }}">
                                            @csrf
                                            <input type="hidden" name="testimonial" value="{{ $testimonial->code }}" required>
