<x-kit.dashboard>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.dashboard.settings.save') }}">
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.dashboard.settings.accounts.save') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="{{ route('admin.dashboard.settings.accounts.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="text-center">
                                    <form method="post" action="{{ route('admin.dashboard.settings.accounts.delete') }}">
                                        @csrf
                                        <input type="hidden" name="account" value="{{ $account->code }}" required>
